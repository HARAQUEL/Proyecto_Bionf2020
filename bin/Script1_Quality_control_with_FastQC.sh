...
# Asterisk before .fq.gz means that it wil analyze all the FASTQ format and gzip-compressed files; there are ten samples in lane 1.
...
# For this, you will create a directory named "Proyecto_final", and inside create one subdirectory: "data"
